...
import {
  Paper, Toolbar, IconButton, Button, OutlinedInput, InputAdornment, Popover, FormControl, InputLabel, Select, MenuItem, FormGroup, FormControlLabel, Checkbox, Badge, Switch
} from '@mui/material';
...
const MainPage = () => {
  ...
  const handleChangeTest = async (deviceId ) => {
    // const selectedFrom = moment().startOf('day');
